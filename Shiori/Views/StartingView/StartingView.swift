...
struct StartingView: View {
    ...
    var body: some View {
        ...
        .navigationDestination(isPresented: $viewModel.goToSignInView) { SignInView(userService: userService)
        }
        .navigationDestination(isPresented: $viewModel.goToSignUpView) { SignUpView(userService: userService)
        }
    }
}
...
#Preview {
    ...
    StartingView(userService: DefaultUserService(authRepository: FirebaseAuthRepository(), newsDatabaseRepository: MockNewsDatabaseRepository(), modelContext: container.mainContext))
}
